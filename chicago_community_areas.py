# This file is generated by a professional data scientist Craig Booth
# (https://github.com/craigmbooth). Our team needed the code in order
# to convert (longitude, latitude) into neighborhood code by
# using his geocoding file. We converted some of his codes that runs
# in python 2.7 so that it would work in python 3.0.
