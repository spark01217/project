...
FILES = [
'../raw_file/school_reports/2012.csv',
'../raw_file/school_reports/2013.csv',
'../raw_file/school_reports/2014.csv',
'../raw_file/school_reports/2016.csv',
]
...
def write_index_to_csv(index):
    ...
    Create a csv file for each year from the nested dictionaries.
    '''
    filename = '../raw_file/school_quality.csv'
    with open(filename, 'w') as output_file:
        for year in index:
